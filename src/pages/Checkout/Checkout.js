...
import { UserOutlined, CloseOutlined, CheckOutlined, UsergroupAddOutlined } from '@ant-design/icons';
import { DAT_VE } from '../../redux/actions/types/QuanLyPhongVeType';
    ...
    return danhSachGhe.map((ghe, index) => {
      ...
      return <Fragment key={index}>
        <button onClick={() => {
          ...
          {ghe.daDat ? classGheDaDuocDat != '' ? <UserOutlined style={{ fontWeight: 'bold', verticalAlign: 'middle' }} /> : <CloseOutlined style={{ fontWeight: 'bold', verticalAlign: 'middle' }} /> : classGheKhachDat !== '' ? <UsergroupAddOutlined style={{ fontWeight: 'bold', verticalAlign: 'middle' }} /> : ghe.stt}
